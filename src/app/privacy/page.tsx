        ...
        <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8 py-8 flex flex-col gap-6 items-center">
          ...
          <div className="w-full max-w-2xl bg-white/80 backdrop-blur-md rounded-[24px] border border-[rgba(80,84,120,0.12)] p-6 shadow-sm flex flex-col gap-5 text-xs text-[#6E7180] leading-relaxed">
            ...
            <div>
              ...
              <p>
                ユーザーが診断中に入力した設問の回答内容（気分やその他の条件）は、お使いの端末（ブラウザ）内での選曲計算にのみ一時的に使用され、通信を介してサーバーに送信・記録されることは一切ありません。現在地の天気条件の取得に必要な位置情報（緯度・経度等）もブラウザ内で直接外部API（Open-Meteo）を呼び出すために一時使用するのみで、サーバーには保存されません。
              </p>
            </div>

            <div>
              <h3 className="font-bold text-[#171725] text-sm tracking-wide mb-1.5">
                4. Cookie（クッキー）および類似技術の不使用
              </h3>
              <p>
                当サイトでは、ユーザーを識別・追跡するためのCookie（クッキー）やその他類似するトラッキング技術を一切使用していません。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1.5">
                なお、当サイト独自のアクセス解析ツール（Google Analytics等）やパフォーマンス追跡ツール（Vercel Web Analytics, Vercel Speed Insights等）は導入および利用していません。
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                本プライバシーポリシーの内容は、関係法令の改正やサイト運営方針の変更等に伴い、予告なく改定されることがあります。改定後のポリシーは、当ページに掲載された時点より有効となります。
              </p>
            </div>
